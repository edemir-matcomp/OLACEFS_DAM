...
def send_task(x, y, bands, satellite, flag_clouds, mask, satellite_name):
        ...
        for not_dam in not_dam_list:
            for dam in range(data.shape[0]):
                ...
                if not_dam:
                    ...
                    # Dam 
                    try:
                        send_task(x, y, bands, satellite, flag_clouds, mask, satellite_name)
                    except:
